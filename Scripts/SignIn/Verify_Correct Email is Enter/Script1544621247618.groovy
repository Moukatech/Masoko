...
WebUI.setText(findTestObject('Signin Page/Input-Email'), findTestData('SigninValidations').getValue(2, 1))

WebUI.delay(2)

WebUI.setText(findTestObject('Signin Page/Input-Password'), findTestData('SigninValidations').getValue(3, 1))
